...
(() => {
  ...
  function updateBookingMessage() {
    const rules = window.BEAUTY_STUDIO_CONTENT?.bookingRules || {};
    const message = localized(rules, "bookingMessage", localized(window.BEAUTY_STUDIO_CONTENT || {}, "bookingMessage", "")).trim();
    if (!message) return;
