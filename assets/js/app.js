...
/* ---------- V78 trilingual UI: English / 中文 / မြန်မာ ---------- */
(function(){
  ...
  function apply(){ document.documentElement.lang=currentLang==='my'?'my':(currentLang==='zh'?'zh-CN':'en'); walk(document.body); document.querySelectorAll('[placeholder]').forEach(el=>{const b=el.dataset.i18nPlaceholder||el.getAttribute('placeholder');if(!el.dataset.i18nPlaceholder)el.dataset.i18nPlaceholder=b;const t=translateText(b);if(t)el.setAttribute('placeholder',t)}); document.querySelectorAll('[aria-label]').forEach(el=>{const b=el.dataset.i18nAria||el.getAttribute('aria-label');if(!el.dataset.i18nAria)el.dataset.i18nAria=b;const t=translateText(b);if(t)el.setAttribute('aria-label',t)}); const b=document.getElementById('beautyLangToggle');if(b)b.textContent=currentLang==='en'?'中文':(currentLang==='zh'?'မြန်မာ':'English'); document.documentElement.classList.toggle('lang-my',currentLang==='my'); }
  function toggle(){const order=['en','zh','my'];const i=order.indexOf(currentLang);currentLang=order[(i+1)%order.length];localStorage.setItem(LANG_KEY,currentLang);apply()}
  function addToggle(){if(document.getElementById('beautyLangToggle'))return;const b=document.createElement('button');b.id='beautyLangToggle';b.type='button';b.className='beauty-lang-toggle';b.setAttribute('aria-label','切换语言');b.addEventListener('click',toggle);document.body.appendChild(b)}
...
(function(){const X={"Skip to content": ["跳转到内容", "အကြောင်းအရာသို့ သွားရန်"], "NAILS & BEAUTY": ["美甲与美丽", "လက်သည်းအလှနှင့် အလှအပ"], "A little beauty, made for you": ["为你而生的一点美好", "သင့်အတွက် ဖန်တီးထားတဲ့ အလှအပလေး"], "Your nails.": ["你的指尖。", "သင့်လက်သည်းများ။"], "Your style.": ["你的风格。", "သင့်စတိုင်။"], "FEATURED STYLE": ["精选款式", "ရွေးချယ်ထားသော ဒီဇိုင်း"], "Soft Blush": ["柔粉裸色", "နူးညံ့ပန်းရောင်"], "Clean · Elegant · Everyday": ["干净 · 优雅 · 日常", "သန့်ရှင်း · ကြော့ရှင်း · နေ့စဉ်"], "NAIL ART": ["美甲艺术", "လက်သည်းအလှဒီဇိုင်း"], "MANICURE": ["美甲护理", "လက်သည်းအလှပြင်"], "GEL NAILS": ["凝胶美甲", "ဂျယ်လ် လက်သည်း"], "SELF CARE": ["自我呵护", "ကိုယ့်ကိုယ်ကို ဂရုစိုက်ခြင်း"], "Choose your": ["选择你的", "သင့်အတွက် ရွေးချယ်ပါ"], "moment.": ["时光。", "အချိန်လေး။"], "Thoughtful nail care, refined finishes and little details made around you.": ["细致的美甲护理、精致的收尾，以及围绕你的每一个小细节。", "ဂရုတစိုက် လက်သည်းအလှပြင်မှု၊ သပ်ရပ်တဲ့အပြီးသတ်မှုနဲ့ သင့်အတွက် အထူးဂရုစိုက်ထားတဲ့ အသေးစိတ်လေးတွေ။"], "PRICING & TIMING ARE SHOWN BEFORE YOU BOOK": ["预约前会显示价格与时长", "ရက်ချိန်းမယူမီ စျေးနှုန်းနှင့် ကြာချိန်ကို ပြသပေးပါမည်"], "THE EVERYDAY EDIT": ["日常系列", "နေ့စဉ်ဒီဇိုင်းစီးရီး"], "THE SIGNATURE EDIT": ["特色系列", "ထူးခြားဒီဇိုင်းစီးရီး"], "THE LENGTH EDIT": ["延长系列", "လက်သည်းတိုးချဲ့ဒီဇိုင်းစီးရီး"], "Clean, polished and long-lasting nails for everyday elegance.": ["干净、精致、持久，适合每天保持优雅。", "သန့်ရှင်း၊ သပ်ရပ်ပြီး ကြာရှည်ခံကာ နေ့စဉ်ကြော့ရှင်းစွာ ဝတ်ဆင်နိုင်သည်။"], "Your idea, your colors, your little details — made just for you.": ["你的想法、你的颜色、你的细节——为你专属打造。", "သင့်စိတ်ကူး၊ သင့်အရောင်နဲ့ သင့်ရဲ့အသေးစိတ်လေးတွေကို သင့်အတွက် အထူးဖန်တီးပေးမယ်။"], "Beautiful shape and length designed around your natural style.": ["围绕你的自然风格打造漂亮的甲型与长度。", "သင့်ရဲ့ သဘာဝစတိုင်နဲ့ ကိုက်ညီတဲ့ လှပသောပုံစံနဲ့ အရှည်ကို ဖန်တီးပေးမယ်။"], "Clean finish": ["精致收尾", "သပ်ရပ်စွာ အပြီးသတ်"], "Long-lasting": ["持久", "ကြာရှည်ခံ"], "Custom detail": ["定制细节", "စိတ်ကြိုက်အသေးစိတ်"], "Creative": ["创意", "ဖန်တီးမှု"], "Refined": ["精致", "သပ်ရပ်ကြော့ရှင်း"], "Shape · Prep · Gel": ["甲型 · 修整 · 凝胶", "ပုံစံ · ပြင်ဆင်မှု · ဂျယ်လ်"], "Base · Design · Detail": ["基础 · 设计 · 细节", "အခြေခံ · ဒီဇိုင်း · အသေးစိတ်"], "Shape · Length · Finish": ["甲型 · 长度 · 收尾", "ပုံစံ · အရှည် · အပြီးသတ်"], "Not sure what to choose?": ["不知道怎么选？", "ဘာကိုရွေးရမလဲ မသေချာဘူးလား။"], "PERSONALIZED": ["专属推荐", "သင့်အတွက် အထူး"], "Start booking": ["开始预约", "ရက်ချိန်း စတင်ယူရန်"], "STUDIO EDIT": ["工作室精选", "စတူဒီယိုရွေးချယ်မှု"], "Color · Detail · Mood": ["颜色 · 细节 · 氛围", "အရောင် · အသေးစိတ် · ခံစားချက်"], "Special for you": ["为你特别准备", "သင့်အတွက် အထူးပြင်ဆင်ထားသည်"], "New look.": ["新造型。", "ဒီဇိုင်းအသစ်။"], "New mood.": ["新心情。", "ခံစားချက်အသစ်။"], "Seasonal colors, little details and styles made for the moments you want to remember.": ["季节色彩、细节与风格，为你想珍藏的时刻而准备。", "ရာသီအလိုက်အရောင်များ၊ အသေးစိတ်လေးများနဲ့ သင်မှတ်မိနေချင်တဲ့ အချိန်လေးတွေအတွက် ဖန်တီးထားတဲ့ ဒီဇိုင်းများ။"], "See promotions": ["查看特别活动", "အထူးအစီအစဉ်များကို ကြည့်ရန်"], "02 · Our Work": ["02 · 我们的作品", "02 · ကျွန်ုပ်တို့၏ လက်ရာများ"], "Real nails.": ["真实作品。", "တကယ့်လက်ရာများ။"], "Real happiness.": ["真实的快乐。", "တကယ့်ပျော်ရွှင်မှု။"], "View all work": ["查看全部作品", "လက်ရာများအားလုံးကို ကြည့်ရန်"], "Find your mood": ["找到你的风格", "သင့်စတိုင်ကို ရှာပါ"], "All": ["全部", "အားလုံး"], "Simple": ["简约", "ရိုးရှင်း"], "Elegant": ["优雅", "ကြော့ရှင်း"], "Trendy": ["时尚", "ခေတ်မီ"], "Cute": ["可爱", "ချစ်စရာ"], "styles": ["款式", "ဒီဇိုင်းများ"], "03 · The Studio": ["03 · 工作室", "03 · စတူဒီယို"], "A quiet space for": ["一个安静的空间，留给", "တိတ်ဆိတ်အေးချမ်းတဲ့ နေရာလေးက"], "yourself.": ["你自己。", "သင့်အတွက်ပါ။"], "Studio signature": ["工作室特色", "စတူဒီယို အထူးလက္ခဏာ"], "Studio philosophy": ["工作室理念", "စတူဒီယို အယူအဆ"], "Quiet appointments, thoughtful details and nails that still feel like you.": ["安静的预约、细致的服务，以及依然像你的指尖。", "အေးချမ်းတဲ့ ရက်ချိန်း၊ ဂရုတစိုက်အသေးစိတ်နဲ့ သင့်ကိုယ်ပိုင်စတိုင်လို ခံစားရတဲ့ လက်သည်းများ။"], "Personal": ["专属", "ကိုယ်ပိုင်"], "Every set starts with your mood, your style and the little details you care about.": ["每一套作品，都从你的心情、风格和在意的细节开始。", "ဒီဇိုင်းတိုင်းဟာ သင့်ခံစားချက်၊ သင့်စတိုင်နဲ့ သင်ဂရုစိုက်တဲ့ အသေးစိတ်လေးတွေကနေ စတင်ပါတယ်။"], "Thoughtful": ["细致", "ဂရုတစိုက်"], "A calm process, considered choices and a finish that feels polished without feeling overdone.": ["从容的过程、经过思考的选择，以及不过度却足够精致的收尾。", "အေးချမ်းတဲ့လုပ်ငန်းစဉ်၊ စဉ်းစားရွေးချယ်ထားတဲ့ ဒီဇိုင်းနဲ့ မလွန်ကဲဘဲ သပ်ရပ်လှပတဲ့ အပြီးသတ်မှု။"], "Yours": ["属于你", "သင့်ပိုင်"], "Save a look, bring an idea or simply choose a color. The final result should still feel like you.": ["收藏一个款式、带来一个灵感，或者只是选择一种颜色。最终效果依然应该像你。", "ဒီဇိုင်းတစ်ခု သိမ်းထားပါ၊ စိတ်ကူးတစ်ခု ယူလာပါ၊ ဒါမှမဟုတ် အရောင်တစ်ရောင်ကို ရွေးပါ။ နောက်ဆုံးရလဒ်ကတော့ သင့်လိုပဲ ဖြစ်နေသင့်ပါတယ်။"], "Professional": ["专业", "ကျွမ်းကျင်"], "Carefully finished": ["精心完成", "ဂရုတစိုက် အပြီးသတ်"], "Relaxing": ["放松", "အနားယူမှု"], "Your time": ["属于你的时间", "သင့်အချိန်"], "Keep Beauty Studio": ["把 Beauty Studio", "Beauty Studio ကို"], "close to you.": ["放在身边。", "သင့်အနားမှာ ထားပါ။"], "Add to Home Screen": ["添加到主屏幕", "ပင်မစာမျက်နှာသို့ ထည့်ရန်"], "Install Beauty Studio": ["安装 Beauty Studio", "Beauty Studio ကို ထည့်သွင်းရန်"], "Available on phones, tablets & computers": ["支持手机、平板和电脑", "ဖုန်း၊ တက်ဘလက်နှင့် ကွန်ပျူတာများတွင် အသုံးပြုနိုင်သည်"], "iPhone / iPad": ["iPhone / iPad", "iPhone / iPad"], "Android": ["Android", "Android"], "Phone / Tablet": ["手机 / 平板", "ဖုန်း / တက်ဘလက်"], "Mac": ["Mac", "Mac"], "Safari / Chrome": ["Safari / Chrome", "Safari / Chrome"], "Windows": ["Windows", "Windows"], "Chrome / Edge": ["Chrome / Edge", "Chrome / Edge"], "Device-aware install guide": ["按设备提供安装指南", "စက်အမျိုးအစားအလိုက် ထည့်သွင်းရန် လမ်းညွှန်"], "YOUR DEVICE": ["你的设备", "သင့်စက်"], "Add Beauty Studio": ["添加 Beauty Studio", "Beauty Studio ကို ထည့်ရန်"], "to your home screen.": ["到主屏幕。", "ပင်မစာမျက်နှာသို့။"], "Follow the steps for your device. Once Beauty Studio is added, this button will disappear.": ["按照你的设备步骤操作。添加 Beauty Studio 后，这个按钮会消失。", "သင့်စက်အတွက် အဆင့်များအတိုင်း လုပ်ဆောင်ပါ။ Beauty Studio ထည့်ပြီးသွားပါက ဒီခလုတ် ပျောက်သွားပါမယ်။"], "Open the browser menu": ["打开浏览器菜单", "ဘရောက်ဇာမီနူးကို ဖွင့်ပါ"], "Open the sharing or browser menu on your device.": ["打开设备上的分享或浏览器菜单。", "သင့်စက်ပေါ်ရှိ မျှဝေခြင်း သို့မဟုတ် ဘရောက်ဇာမီနူးကို ဖွင့်ပါ။"], "Choose Add to Home Screen": ["选择“添加到主屏幕”", "“ပင်မစာမျက်နှာသို့ ထည့်ရန်” ကို ရွေးပါ"], "Select the option to add Beauty Studio.": ["选择添加 Beauty Studio 的选项。", "Beauty Studio ထည့်ရန် ရွေးချယ်မှုကို ရွေးပါ။"], "You're ready": ["准备好了", "အသင့်ဖြစ်ပါပြီ"], "Beauty Studio will appear as an app on your device.": ["Beauty Studio 会以应用形式出现在你的设备上。", "Beauty Studio ကို သင့်စက်တွင် အက်ပ်တစ်ခုအဖြစ် တွေ့ရပါမယ်။"], "I've added it": ["我已经添加", "ထည့်ပြီးပါပြီ"], "Maybe later": ["稍后再说", "နောက်မှလုပ်မယ်"], "04 · Appointments": ["04 · 预约", "04 · ရက်ချိန်းများ"], "Ready for your": ["准备好迎接你的", "သင့်ရဲ့"], "next set?": ["下一套美甲了吗？", "နောက်ထပ်ဒီဇိုင်းအတွက် အသင့်ဖြစ်ပြီလား။"], "Choose your service, find a convenient time and let us take care of the details.": ["选择服务、找到合适的时间，其余细节交给我们。", "ဝန်ဆောင်မှုကို ရွေးပြီး အဆင်ပြေတဲ့အချိန်ကို ရွေးပါ။ ကျန်တဲ့အသေးစိတ်ကို ကျွန်ုပ်တို့က ဂရုစိုက်ပေးပါမယ်။"], "Personal care": ["专属护理", "ကိုယ်ပိုင်ဂရုစိုက်မှု"], "Flexible time": ["灵活时间", "အဆင်ပြေတဲ့အချိန်"], "Easy booking": ["轻松预约", "လွယ်ကူသော ရက်ချိန်း"], "05 · Find Us": ["05 · 找到我们", "05 · ကျွန်ုပ်တို့ကို ရှာရန်"], "Come say": ["来和我们", "လာပြီး"], "hello.": ["打个招呼吧。", "နှုတ်ဆက်လိုက်ပါ။"], "Questions, bookings, or simply a friendly hello — we’re always here for you.": ["有问题、想预约，或者只是想打个招呼——我们一直都在。", "မေးခွန်းများ၊ ရက်ချိန်းများ သို့မဟုတ် နှုတ်ဆက်ချင်ရုံပဲဖြစ်ဖြစ် — ကျွန်ုပ်တို့ အမြဲရှိနေပါတယ်။"], "Location": ["地址", "တည်နေရာ"], "Studio address will appear here": ["工作室地址将在这里显示", "စတူဒီယိုလိပ်စာကို ဒီနေရာမှာ ပြသပေးပါမယ်"], "View on Maps →": ["在地图上查看 →", "မြေပုံပေါ်တွင် ကြည့်ရန် →"], "Hours": ["营业时间", "ဖွင့်ချိန်"], "See availability →": ["查看可预约时间 →", "ရနိုင်သောအချိန်ကို ကြည့်ရန် →"], "Call studio →": ["致电工作室 →", "စတူဒီယိုကို ဖုန်းဆက်ရန် →"], "By appointment only": ["仅限预约", "ကြိုတင်ရက်ချိန်းဖြင့်သာ"], "Appointments are confirmed after your request is reviewed.": ["预约请求审核后才会确认。", "သင့်တောင်းဆိုမှုကို စစ်ဆေးပြီးမှ ရက်ချိန်းကို အတည်ပြုပေးပါမယ်။"], "STAY CLOSE": ["保持联系", "နီးနီးကပ်ကပ်ရှိပါ"], "Follow →": ["关注 →", "Follow →"], "Message the Studio": ["联系工作室", "စတူဒီယိုထံ စာပို့ရန်"], "Chat now →": ["立即聊天 →", "ယခု စကားပြောရန် →"], "Join →": ["加入 →", "ဝင်ရောက်ရန် →"], "STUDIO NOTE": ["工作室寄语", "စတူဒီယိုမှတ်စု"], "Good nails.": ["漂亮的指尖。", "လှပတဲ့ လက်သည်းများ။"], "Brighter days.": ["更明亮的每一天。", "ပိုမိုတောက်ပတဲ့နေ့ရက်များ။"], "Made for beautiful little moments.": ["为每一个美好小瞬间而打造。", "လှပတဲ့ အချိန်လေးတိုင်းအတွက် ဖန်တီးထားပါတယ်။"], "STYLE": ["风格", "စတိုင်"], "MOOD": ["氛围", "ခံစားချက်"], "Soft & polished": ["柔和而精致", "နူးညံ့ပြီး သပ်ရပ်လှပ"], "RECOMMENDED": ["推荐", "အကြံပြုထားသည်"], "Love this look? Bring it as inspiration and the studio can fine-tune the details for you.": ["喜欢这个款式？可以带来作为灵感，我们会为你细调细节。", "ဒီဒီဇိုင်းကို ကြိုက်ပါသလား။ စိတ်ကူးအဖြစ် ယူလာနိုင်ပြီး အသေးစိတ်ကို သင့်အတွက် ပြန်လည်ညှိပေးနိုင်ပါတယ်။"], "Natural beauty, lasting glow.": ["自然之美，持久光彩。", "သဘာဝအလှ၊ ကြာရှည်တောက်ပမှု။"], "Care": ["护理", "ဂရုစိုက်မှု"], "What's included": ["包含内容", "ပါဝင်သောအရာများ"], "Final price may vary with length, design detail and add-ons.": ["最终价格可能因长度、设计细节和附加项目而有所不同。", "နောက်ဆုံးစျေးနှုန်းသည် အရှည်၊ ဒီဇိုင်းအသေးစိတ်နှင့် ထပ်ဆောင်းဝန်ဆောင်မှုများအပေါ် မူတည်ပြီး ကွာခြားနိုင်ပါတယ်။"], "Appointments": ["预约", "ရက်ချိန်းများ"], "Book your": ["预约你的", "သင့်ရဲ့"], "PRIVATE APPOINTMENT": ["私人预约", "ကိုယ်ပိုင်ရက်ချိန်း"], "A little time, made entirely for you.": ["一小段完全属于你的时光。", "သင့်အတွက်ပဲ အထူးဖန်တီးထားတဲ့ အချိန်လေး။"], "BY APPOINTMENT": ["预约制", "ကြိုတင်ရက်ချိန်းဖြင့်"], "Choose a service": ["选择服务", "ဝန်ဆောင်မှုကို ရွေးချယ်ပါ"], "You can change this later.": ["之后可以修改。", "နောက်မှ ပြောင်းလဲနိုင်ပါတယ်။"], "The final price can vary with length, design detail and any add-ons.": ["最终价格可能因长度、设计细节和附加项目而有所不同。", "နောက်ဆုံးစျေးနှုန်းသည် အရှည်၊ ဒီဇိုင်းအသေးစိတ်နှင့် ထပ်ဆောင်းဝန်ဆောင်မှုများအပေါ် မူတည်ပြီး ကွာခြားနိုင်ပါတယ်။"], "Pick a day first, then a time.": ["请先选择日期，再选择时间。", "အရင်ဆုံး ရက်စွဲရွေးပြီးနောက် အချိန်ကို ရွေးပါ။"], "Back to service": ["返回服务选择", "ဝန်ဆောင်မှုသို့ ပြန်ရန်"], "Choose date": ["选择日期", "ရက်စွဲရွေးရန်"], "Pick a date": ["选择一个日期", "ရက်စွဲတစ်ခု ရွေးပါ"], "Available times": ["可预约时间", "ရနိုင်သော အချိန်များ"], "Live availability · based on studio rules": ["实时可预约时间 · 根据工作室规则", "စတူဒီယိုစည်းမျဉ်းများအပေါ် အခြေခံထားသော အချိန်ရရှိမှု"], "Back to date & time": ["返回日期与时间", "ရက်စွဲနှင့် အချိန်သို့ ပြန်ရန်"], "We’ll use these details to confirm your appointment.": ["我们会使用这些信息确认你的预约。", "ဒီအချက်အလက်များကို အသုံးပြုပြီး သင့်ရက်ချိန်းကို အတည်ပြုပေးပါမယ်။"], "Inspiration": ["灵感", "စိတ်ကူး"], "Price": ["价格", "စျေးနှုန်း"], "Duration": ["时长", "ကြာချိန်"], "Thoughtful from start to finish.": ["从开始到结束都用心。", "အစမှ အဆုံးထိ ဂရုတစိုက်။"], "Your request is reviewed by the Studio before the appointment is confirmed.": ["你的预约请求会先由工作室审核，再最终确认。", "ရက်ချိန်းကို အတည်မပြုမီ စတူဒီယိုမှ သင့်တောင်းဆိုမှုကို စစ်ဆေးပေးပါမယ်။"], "Request received.": ["已收到请求。", "တောင်းဆိုမှုကို လက်ခံရရှိပါပြီ။"], "Your appointment request is ready. The Studio will confirm the final time with you.": ["你的预约请求已提交。工作室会与你确认最终时间。", "သင့်ရဲ့ ရက်ချိန်းတောင်းဆိုမှု ပို့ပြီးပါပြီ။ နောက်ဆုံးအချိန်ကို စတူဒီယိုမှ သင့်နှင့် အတည်ပြုပေးပါမယ်။"], "Done": ["完成", "ပြီးပါပြီ"], "Customer notifications": ["客户通知", "ဖောက်သည် အသိပေးချက်များ"], "Updates": ["更新", "အပ်ဒိတ်များ"], "No new updates yet.": ["目前没有新的更新。", "လတ်တလော အပ်ဒိတ်အသစ် မရှိသေးပါ။"], "Customer support chat": ["客户咨询", "ဖောက်သည်အကူအညီ စကားပြောခန်း"], "Need help?": ["需要帮助吗？", "အကူအညီလိုပါသလား။"], "Beauty Studio · Support": ["Beauty Studio · 客户支持", "Beauty Studio · ဖောက်သည်အကူအညီ"], "How can we help?": ["有什么可以帮助您？", "ဘယ်လိုကူညီပေးရမလဲ။"], "Customer —": ["客户 —", "ဖောက်သည် —"], "We usually reply as soon as we can.": ["我们通常会尽快回复。", "ကျွန်ုပ်တို့က တတ်နိုင်သမျှ အမြန်ဆုံး ပြန်စာပို့ပေးပါတယ်။"], "Ask us anything about services, designs or your appointment.": ["关于服务、款式或预约，都可以问我们。", "ဝန်ဆောင်မှု၊ ဒီဇိုင်း သို့မဟုတ် ရက်ချိန်းနဲ့ပတ်သက်ပြီး ဘာမဆို မေးနိုင်ပါတယ်။"], "Send": ["发送", "ပို့ရန်"], "Your conversation stays with your Customer ID after refresh.": ["刷新后，你的聊天记录仍会与客户编号关联。", "Refresh လုပ်ပြီးနောက်လည်း သင့်စကားပြောမှတ်တမ်းကို Customer ID နှင့် ဆက်လက်ချိတ်ဆက်ထားပါမယ်။"], "© 2026": ["© 2026", "© 2026"], "Beauty Studio content hub. Update this one block when the real studio opens.": ["Beauty Studio 内容中心。正式开店后可在这里更新这段内容。", "Beauty Studio အကြောင်းအရာနေရာ။ စတူဒီယိုတကယ်ဖွင့်ချိန်တွင် ဒီအပိုင်းကို ပြင်ဆင်နိုင်ပါတယ်။"], "Connecting to D1…": ["正在连接 D1…", "D1 သို့ ချိတ်ဆက်နေသည်…"], "CONTROL CENTER": ["控制中心", "စီမံခန့်ခွဲရေးစင်တာ"], "Everything happening in your studio, at a glance.": ["工作室的一切，一眼掌握。", "စတူဒီယိုမှာ ဖြစ်ပျက်သမျှကို တစ်ချက်ကြည့်ရုံနဲ့ သိနိုင်ပါတယ်။"], "Today": ["今天", "ယနေ့"], "—": ["—", "—"], "Loading…": ["加载中…", "ဖွင့်နေသည်…"], "Need your review": ["需要你处理", "သင့်စစ်ဆေးမှု လိုအပ်သည်"], "From Need Help": ["来自客户咨询", "ဖောက်သည်အကူအညီမှ"], "Seen in bookings & messages": ["来自预约和消息", "ရက်ချိန်းများနှင့် စာများမှ"], "View all →": ["查看全部 →", "အားလုံးကြည့်ရန် →"], "Loading today's bookings…": ["正在加载今日预约…", "ယနေ့ရက်ချိန်းများကို ဖွင့်နေသည်…"], "CUSTOMER CARE": ["客户服务", "ဖောက်သည်ဝန်ဆောင်မှု"], "Open inbox →": ["打开消息中心 →", "စာများကို ဖွင့်ရန် →"], "Loading messages…": ["正在加载消息…", "စာများကို ဖွင့်နေသည်…"], "RECENT ACTIVITY": ["最近活动", "လတ်တလော လုပ်ဆောင်ချက်"], "Manage →": ["管理 →", "စီမံရန် →"], "Loading activity…": ["正在加载活动…", "လုပ်ဆောင်ချက်များကို ဖွင့်နေသည်…"], "STUDIO PROFILE": ["工作室资料", "စတူဒီယိုအချက်အလက်"], "These details are stored in D1 and become the single source of truth.": ["这些资料保存在 D1，并作为网站统一数据来源。", "ဒီအချက်အလက်တွေကို D1 မှာ သိမ်းထားပြီး ဝဘ်ဆိုဒ်အတွက် အဓိကအချက်အလက်အဖြစ် အသုံးပြုပါမယ်။"], "Save changes": ["保存更改", "ပြောင်းလဲမှုများကို သိမ်းရန်"], "Studio name": ["工作室名称", "စတူဒီယိုအမည်"], "City": ["城市", "မြို့"], "Address": ["地址", "လိပ်စာ"], "Booking message": ["预约提示", "ရက်ချိန်း အကြောင်းကြားစာ"], "SERVICE MENU": ["服务菜单", "ဝန်ဆောင်မှုမီနူး"], "Edit the menu shown on the customer website.": ["编辑客户网站上显示的服务菜单。", "ဖောက်သည်ဝဘ်ဆိုဒ်တွင် ပြသမည့် ဝန်ဆောင်မှုမီနူးကို ပြင်ဆင်ပါ။"], "＋ Add service": ["＋ 添加服务", "＋ ဝန်ဆောင်မှု ထည့်ရန်"], "PORTFOLIO": ["作品集", "လက်ရာစုစည်းမှု"], "Manage looks, categories and descriptions. Photos remain local until R2 is available.": ["管理款式、分类和描述。R2 启用前照片暂时保存在本地。", "ဒီဇိုင်းများ၊ အမျိုးအစားများနဲ့ ဖော်ပြချက်များကို စီမံပါ။ R2 အသုံးပြုနိုင်သည်အထိ ဓာတ်ပုံများကို လက်ရှိနေရာတွင် သိမ်းထားပါမယ်။"], "＋ Add look": ["＋ 添加作品", "＋ လက်ရာ ထည့်ရန်"], "MEDIA LIBRARY": ["媒体库", "မီဒီယာစာကြည့်တိုက်"], "Media slots": ["媒体位置", "မီဒီယာနေရာများ"], "APPOINTMENTS": ["预约", "ရက်ချိန်းများ"], "Customer requests received from the website.": ["来自客户网站的预约请求。", "ဖောက်သည်ဝဘ်ဆိုဒ်မှ လက်ခံရရှိသော ရက်ချိန်းတောင်းဆိုမှုများ။"], "Refresh": ["刷新", "ပြန်လည်ဖွင့်ရန်"], "Loading booking requests…": ["正在加载预约请求…", "ရက်ချိန်းတောင်းဆိုမှုများကို ဖွင့်နေသည်…"], "Loading conversations…": ["正在加载聊天…", "စကားပြောခန်းများကို ဖွင့်နေသည်…"], "Select a conversation to reply.": ["选择一个对话进行回复。", "ပြန်စာပို့ရန် စကားပြောခန်းတစ်ခုကို ရွေးပါ။"], "Control when customers can request appointments.": ["设置客户何时可以提交预约。", "ဖောက်သည်များ ရက်ချိန်းတောင်းနိုင်မည့် အချိန်ကို ထိန်းချုပ်ပါ။"], "Opening time": ["开始营业时间", "ဖွင့်ချိန်"], "Closing time": ["结束营业时间", "ပိတ်ချိန်"], "Slot interval": ["时间间隔", "အချိန်ကြားကာလ"], "15 minutes": ["15 分钟", "15 မိနစ်"], "30 minutes": ["30 分钟", "30 မိနစ်"], "60 minutes": ["60 分钟", "60 မိနစ်"], "Advance days": ["提前预约天数", "ကြိုတင်ရက်ချိန်းယူနိုင်သည့် ရက်အရေအတွက်"], "Minimum lead time": ["最短提前时间", "အနည်းဆုံး ကြိုတင်ချိန်"], "Booking status": ["预约状态", "ရက်ချိန်းအခြေအနေ"], "Open": ["开放", "ဖွင့်ထားသည်"], "Paused": ["暂停", "ခေတ္တရပ်ထားသည်"], "Add your studio to this device": ["将工作室后台添加到此设备", "စတူဒီယိုစီမံခန့်ခွဲရေးကို ဒီစက်ထဲ ထည့်ရန်"], "Use Admin like an app from your desktop or home screen. Your secure Admin login stays the same.": ["像应用一样从桌面或主屏幕使用后台。安全登录方式保持不变。", "Desktop သို့မဟုတ် ပင်မစာမျက်နှာမှ အက်ပ်တစ်ခုလို Admin ကို အသုံးပြုနိုင်ပါတယ်။ လုံခြုံသော Admin login က မပြောင်းလဲပါ။"], "Install now": ["立即安装", "ယခု ထည့်သွင်းရန်"], "No App Store or Play Store download is required.": ["无需从 App Store 或 Play Store 下载。", "App Store သို့မဟုတ် Play Store မှ ဒေါင်းလုဒ်လုပ်ရန် မလိုပါ။"]};const key="beauty_studio_language";const orig=new WeakMap();function lang(){return localStorage.getItem(key)||"zh"}function run(){const l=lang();const w=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT);const ns=[];let n;while(n=w.nextNode())ns.push(n);ns.forEach(x=>{if(!x.nodeValue.trim())return;const p=x.parentElement;if(!p||["SCRIPT","STYLE","NOSCRIPT"].includes(p.tagName))return;let b=orig.get(x);if(b===undefined){b=x.nodeValue;orig.set(x,b)}const pair=X[b.trim()];if(pair){const lead=b.match(/^\s*/)?.[0]||"";const trail=b.match(/\s*$/)?.[0]||"";x.nodeValue=lead+pair[l==="my"?1:0]+trail}})}const o=new MutationObserver(m=>{let c=false;m.forEach(x=>{if(x.addedNodes.length)c=true});if(c)run()});function s(){run();o.observe(document.body,{childList:true,subtree:true})}if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",s);else s()})();
